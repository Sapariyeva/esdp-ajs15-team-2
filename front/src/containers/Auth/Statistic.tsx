    ...
    return (
        <Container disableGutters sx={{ margin: 0 }} maxWidth={false}>
            ...
            <Grid display="flex" alignItems="center" flexDirection={"column"}>
                <Typography variant="h5" fontFamily={'Blue Curve'}>С вами поделились статистикой студента. </Typography>
                <Typography variant="h5" fontFamily={'Blue Curve'}>Необходимо войти в Ваш профиль ильи зарегестрироваться</Typography>
            </Grid>
